...
public class PublicDaoImpl implements PublicDao{
	...
	@Override
	public void alertSuccess(String message, PrintWriter out,String page) {
		out.println("<!DOCTYPE html>"); 
		out.println("<html>"); 
		out.println("<head>");
		out.println("<script src=\"https://unpkg.com/sweetalert/dist/sweetalert.min.js\"></script>"); 
		...
		out.println("swal(\"Congrats!\", \""+message+"\", \"success\")"); 
		out.println(".then((value) => {"); 
		out.println("location='http://localhost:8080/Final/"+page+"'"); 
		out.println("});");
		out.println("</script>");
		out.println("</body>");
		out.println("</html>"); 
	...
	@Override
	public void alertFail(String message, PrintWriter out,String page) {
		out.println("<!DOCTYPE html>"); 
		out.println("<html>"); 
		out.println("<head>");
		out.println("<script src=\"https://unpkg.com/sweetalert/dist/sweetalert.min.js\"></script>"); 
